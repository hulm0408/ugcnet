    ...
    <div className="flex flex-col h-screen bg-[#FCFAF8] font-sans overflow-hidden">
      ...
      <div className="flex items-center gap-6 sm:gap-8 px-4 sm:px-6 py-3 bg-stone-50 border-b border-stone-200 shrink-0 text-[10px] sm:text-xs font-bold text-stone-600 overflow-x-auto whitespace-nowrap z-10 no-scrollbar">
        <div className="flex items-center gap-2">
          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#107A53] shrink-0" /> Answered
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-rose-500 shrink-0" /> Not Answered
        </div>
        <div className="flex items-center gap-2">
          <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#D97706] shrink-0" /> Marked for Review
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white z-0 h-full">
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
            <div className="flex items-center justify-between mb-4 sm:mb-6">
              ...
              {evaluations[currentQ.id] && (
                evaluations[currentQ.id].isCorrect ? (
                  <span className="px-2 py-1 sm:px-3 sm:py-1 bg-[#107A53]/10 text-[#107A53] text-xs sm:text-sm font-bold rounded uppercase tracking-wider flex items-center gap-1.5">
                  ...
                  <span className="px-2 py-1 sm:px-3 sm:py-1 bg-rose-100 text-rose-700 text-xs sm:text-sm font-bold rounded uppercase tracking-wider flex items-center gap-1.5">
              ...
              {['A', 'B', 'C', 'D'].map((opt) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && !evalRes && (
                      <div className="ml-auto shrink-0 w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-[#107A53] text-white flex items-center justify-center">
                        <svg width="12" height="10" viewBox="0 0 14 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 5L5 9L13 1" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </div>
            ...
            {evaluations[currentQ.id]?.explanation && (
              <div className="bg-[#107A53]/5 border border-[#107A53]/20 rounded-2xl p-4 sm:p-6 mb-4">
